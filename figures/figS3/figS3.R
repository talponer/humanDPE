C  =as.matrix(read.table("hg19_epd05_C10_s14_s0.dat",header=F))

C01=as.matrix(read.table("hg19_epd05_C10_s14_s1.dat",header=F))
C02=as.matrix(read.table("hg19_epd05_C10_s14_s2.dat",header=F))
C03=as.matrix(read.table("hg19_epd05_C10_s14_s3.dat",header=F))
C04=as.matrix(read.table("hg19_epd05_C10_s14_s4.dat",header=F))
C05=as.matrix(read.table("hg19_epd05_C10_s14_s5.dat",header=F))
C06=as.matrix(read.table("hg19_epd05_C10_s14_s6.dat",header=F))
C07=as.matrix(read.table("hg19_epd05_C10_s14_s7.dat",header=F))
C08=as.matrix(read.table("hg19_epd05_C10_s14_s8.dat",header=F))
C09=as.matrix(read.table("hg19_epd05_C10_s14_s9.dat",header=F))
C10=as.matrix(read.table("hg19_epd05_C10_s14_s10.dat",header=F))
