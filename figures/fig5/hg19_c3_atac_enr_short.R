infile="hg19_c3_atac_enr.txt"

outfile="hg19_c3_atac_enr_short.pdf"
...
axis(1, at=seq(0.5, points, step2),
   labels=seq(data[1,1]+1, data[points, 1]+1, step2),
   cex.axis=1.2)
legend('topright', bty='n',
   legend=c('Homo sapiens', 'Class 3: Inr+DPE', '3.0%'),
